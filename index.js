...
CodeMirror.defineSimpleMode("zenscript", {
    start: [
        ...
        {regex: /[^.\s]([A-Za-z_$][\w$]*)(\s*(?:\())/, token: ["def", "def", null]},
        {regex: /\b(\w+)(\.)(\w+)((\.)(\w+))*/, token: ["variable-2", "operator", "def"]},
        ...
        {regex: /\b(as)(\s)+([a-zA-Z]+)\b/, token: ["builtin", null, "variable-3"]},
        ...
        {regex: /\b(import)(\s)(.+\.)(.*)(\s*;)/, token: ["keyword", null, "variable-3", "variable-2", "keyword"]},
